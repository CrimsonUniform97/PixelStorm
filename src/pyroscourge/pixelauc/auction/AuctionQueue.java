...
public class AuctionQueue {
	...
	public AuctionQueue(SynchronousScheduler scheduler, Server server) {
		this.scheduler = scheduler;
		this.server = server;
		
		this.startAuction = () -> {
			server.broadcastMessage(new Text.Literal(TextColors.BLUE, TextStyles.NONE, ImmutableList.of(), null, null, null, "Blah blah blah, player, blah, item, blah blah blah blah, price, etc"));
